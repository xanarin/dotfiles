...
# Maximum allowed downlink. Set to 90% of the achievable downlink in mbits/s
DOWNLINK=10

# Interface facing the Internet
EXTDEV=enp0s20f0u3u3
...
tc class add dev ifb0 parent 3: classid 3:3 htb rate ${DOWNLINK}mbit
tc class add dev ifb0 parent 3:3 classid 3:30 htb rate 400kbit ceil ${DOWNLINK}mbit
