...
-- Diagnostic text does not appear in Neovim >= v0.11 without this setting
vim.diagnostic.config({
    virtual_text = true, -- Set to true to enable virtual text for diagnostics
    -- Other diagnostic settings can be configured here
})
